package com.onecode.ffhx.gfx;

public class Constants {
    public static String APP_LINK = "https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID;
    public static String PRO_APP_LINK = "https://play.google.com/store/apps/details?id=com.onecode.ffhx.gfx.pro";
    public static String APP_PRIVACY_LINK = "https://gfxdocs.blogspot.com/2023/07/privacy-policy.html";
    public static String APP_TERMS_LINK = "https://gfxdocs.blogspot.com/2023/07/terms-conditions.html";
    public static String VPN_LINK = "https://play.google.com/store/apps/details?id=com.cloudflare.onedotonedotonedotone";
    public static String TELEGRAM_LINK = "https://t.me/+o480n0cZ1DBiNTJl";
    public static String AD_BLOCKER_LINK = "https://media.admob.com/mobile_ad_guide/";
